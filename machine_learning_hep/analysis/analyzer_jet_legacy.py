...
class AnalyzerJet(Analyzer):
    ...
    def __init__(self, datap, case, typean, period):
        ...
        self.systematic_categories = datap["analysis"][self.typean].get("systematic_categories", None)
    ...
    def efficiency(self):
        ...
        for imult in range(self.p_nbin2_reco):
            ...
            legeffFDstring = "%.1f #leq %s < %.1f GeV/#it{c}" % \
                    (self.lvar2_binmin_gen[imult], self.p_latexbin2var, self.lvar2_binmax_gen[imult])
